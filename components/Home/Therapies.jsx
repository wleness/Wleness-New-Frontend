      ...
      <div className={`container mx-auto pt-8 lg:pt-12 ${is_bg && "lg:pb-12"}`}>
        {is_title && (
          <div className="text-center lg:mb-4">
            <h2 className={`${headingClasses}`}>Best Online Psychologist Consultation</h2>
          </div>
        )}
        {description && (
        ...
        <div className="grid grid-cols-2 gap-2 lg:grid-cols-3 lg:gap-6 lg:py-6 xl:grid-cols-4 2xl:grid-cols-4 2xl:gap-6 mt-16">
