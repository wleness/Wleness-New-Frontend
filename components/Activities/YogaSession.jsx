...
import { yoga__montly_subscription, yoga__one_time_session } from "@public";
...
export default function YogaSession({ title, one_time, one_month }) {
  ...
  return (
    <>
      <section className="pb-5 pt-4 lg:pb-10 bg-primary-two">
        <div className="container mx-auto relative">
          <div className="pb-6 text-center sm:pt-6 lg:pb-14 2xl:pb-8 ">
            <h1 className="subheading sm:pb-0 lg:mb-4">
              {textColorize(title)}
            </h1>
            <span className="mx-auto block h-[3px] w-8 rounded-full bg-primary-one"></span>
          </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="rounded-r-xl border-y border-r border-slate-400 py-6 lg:w-3/5">
                      ...
                      <div className="flex items-center justify-between px-4 lg:px-8">
                        <button
                          ...
                          className="rounded-xl bg-primary-one px-4 py-2.5 text-sm font-medium lg:px-6"
                        >
                          Book Now
                        </button>
