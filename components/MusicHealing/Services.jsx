...
export default function Services({ data, openEnquiry }) {
  return (
    <section className="py-6 lg:py-9 bg-black">
      <div className="container mx-auto">
        <div className="text-center">
          <h1 className="subheading text-primary-one">{data.title}</h1>
          <p className="font-semibold text-slate-300 lg:text-xl">{data.desc}</p>
        </div>
        ...
        <div className="pt-5 text-center">
          <button className="btn-one" onClick={openEnquiry}>
            Enquire Now
          </button>
        </div>
      </div>
