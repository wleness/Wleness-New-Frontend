...
// Data
import { doodle2, doodle3 } from "@public";
import { textColorize } from "@utils";

export default function HappyClient(props) {
  return (
    <section className="relative overflow-clip bg-primary-two px-4 py-6 text-center lg:px-0 lg:py-10">
                ...
                <SwiperSlide key={i}>
                  <figure className="items-center lg:flex">
                    ...
                    <figcaption className="lg:w-3/5">
                      <h4 className="text-center text-2xl font-semibold text-primary-one lg:text-left lg:text-3xl">
                        {value.name}
                      </h4>
                      <h6 className="mb-4 text-center font-medium text-slate-200 lg:text-left xl:text-lg">
                        {value.profession}
                      </h6>
                      <p className="mb-1 text-center text-sm font-medium text-slate-400  md:text-base md:leading-5 lg:pr-8 lg:text-left xl:text-lg">
                        {value.review}
                      </p>
                    </figcaption>
                  </figure>
