...
const SelectBest = React.forwardRef((props, ref) => {
  return (
    <section className="py-3 lg:py-6 bg-slate-900">
      <div className="relative overflow-x-clip">
        <div className="text-center">
          ...
          <div className="container relative mx-auto pt-2 md:flex md:gap-x-8 lg:pt-10">
            ...
            <ul className="grid items-center gap-y-3 pl-5 pt-5 md:w-1/2 md:py-8 z-20">
              {props.features.map((value, index) => {
                return (
                  ...
                  >
                    ...
                    <span className="text-slate-300">{value[1]}</span>
                  </li>
                );
              })}
            </ul>
