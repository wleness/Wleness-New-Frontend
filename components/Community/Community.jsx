...
export default function Community() {
  return (
    <section className="bg-slate-900 pb-8">
      <div className="container mx-auto lg:pt-6 xl:flex xl:items-center xl:gap-5">
        <div className="pt-5 xl:w-1/2 xl:pr-16 text-slate-300">
          <h1 className="subheading mb-6 text-white">
