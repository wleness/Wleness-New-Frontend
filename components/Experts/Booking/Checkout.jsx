import CheckoutInputField from "@components/Forms/CheckoutInputField";
import {
  faAngleLeft,
  faCalendar,
  faSpinner,
  ...
  return (
    <div className="py-6">
      <div className="mb-10 flex items-center justify-between text-center md:flex-row ">
        ...
        <h2 className="text-3xl font-bold text-white">Confirm Booking</h2>
      ...
      <div className="space-y-8 divide-y-2 divide-dashed divide-slate-300">
        <div className="flex justify-center gap-x-2 pb-5 lg:gap-x-5">
          <div className="flex w-1/2 flex-col justify-between rounded-lg border-2 border-primary-one px-4 py-4 text-center font-bold md:w-60 lg:px-8 text-slate-200">
            ...
            <span
              className="cursor-pointer text-center underline transition-all hover:text-primary-one"
              onClick={back}
            >
              Change
            </span>
          ...
          <div className="w-1/2 rounded-lg border-2 border-primary-one text-slate-200 px-4 py-4 text-center font-bold md:w-60 lg:px-8">
            <p>
            ...
            <span
              className="cursor-pointer underline transition-all hover:text-primary-one"
              onClick={back}
            >
              Change
            </span>
          ...
          <form onSubmit={handleApplyCoupon}>
            <div className="flex gap-4">
              ...
              <div className="w-1/4">
                <button
                  type="submit"
                  className="block w-full rounded-lg bg-primary-one px-6 py-2.5 font-semibold uppercase tracking-wider lg:py-3"
                >
                  Apply
                </button>
              </div>
        ...
        <div className="pt-8">
          ...
          <ul className="border-slate-400 text-slate-300">
            ...
            {couponCode.is_applied ? (
              <li className="mb-3 flex justify-between font-semibold">
                ...
                <span className="text-slate-100">- Rs. {couponCode.price}</span>
              </li>
            ) : null}
            <hr />
            <li className="flex justify-between font-bold text-primary-one">
        ...
        >
          ...
          <div className="mt-3 text-center">
            <button
              className="btn-one mx-auto hover:!border-transparent hover:!text-black flex items-center !rounded-lg disabled:cursor-not-allowed disabled:bg-gray-500 enabled:hover:!bg-primary-one"
              disabled={
            ...
            >
              {makePayment && (
                <FontAwesomeIcon
                  icon={faSpinner}
                  className="mr-2 animate-spin block text-lg"
                />
              )}
              Make Payment
            </button>
