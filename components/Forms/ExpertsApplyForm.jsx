...
export default function ExpertsApplyForm({ name, url, setConfirmation }) {
    ...
    <section className="bg-slate-900 pt-12">
      <div className="container mx-auto">
        ...
        <form className="space-y-6 pb-12" onSubmit={handleFormSubmit}>
          <div>
            <h5 className="mb-3 text-lg font-bold text-primary-one">
              Personal Information
            </h5>
            <div className="grid gap-3 lg:grid-cols-2 lg:gap-x-6 lg:gap-y-4">
              <fieldset className="rounded-xl border-2 border-primary-one text-white">
              ...
              <fieldset className="rounded-xl border-2 border-primary-one text-white">
                ...
                <label htmlFor="email">
                  <input
                    ...
                    onChange={handleChange}
                    id="email"
                    className="w-full rounded-xl text-white bg-transparent px-4 py-1 pb-3 outline-none"
                  />
                </label>
              </fieldset>
              <fieldset className="rounded-xl border-2 border-primary-one text-white">
          ...
          <div className="text-center">
            <input type="submit" value="Submit" className="btn-one" />
          </div>
        </form>
      </div>
    </section>
