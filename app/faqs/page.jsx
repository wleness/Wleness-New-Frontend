...
export const metadata = {
    title: "Find Answers in FAQs & Access Best Online Therapy in India via Psychologist Consultation",
    keywords: [
        "Faq",
    ...
    description:
        "Visit our FAQ for information and schedule an online psychologist consultation. Get the best online therapy in India with the best psychologist. Consult a psychologist online.",
    alternates: {
                ...
                <div className="container mx-auto">
                    ...
                    <div className="lg:mb-4">
                        <Image
                            src={faq3}
                            alt=""
                            className="mx-auto lg:w-[560px]"
                        />
                        <p className="text-center text-sm font-bold sm:text-base lg:px-44 lg:text-xl text-slate-400">
                            Everything you need to know right here at Wleness.
                            Ask questions and browse around for answers.
                        </p>
                    </div>
                </div>
