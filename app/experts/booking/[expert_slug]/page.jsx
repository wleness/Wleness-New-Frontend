...
// Components
import BookingHeading from "@components/Experts/Booking/BookingHeading";
import SessionMode from "@components/Buttons/SessionMode";
import SessionPricingItem from "@components/Experts/Booking/SessionPricingItem";
import AvailableSlots from "@components/Experts/Booking/AvailableSlots";
import Checkout from "@components/Experts/Booking/Checkout";
...
export default function Appointment({ params }) {
  ...
  return (
    <>
      <section className="relative bg-primary-two">
        <div className="absolute left-0 top-0 z-10  h-28 w-full bg-slate-900 lg:bottom-0 lg:left-0 lg:top-0 lg:h-auto lg:w-28"></div>
        <div className="absolute left-0 top-28 z-10 h-28 w-full bg-slate-900 lg:bottom-0 lg:left-28 lg:top-0 lg:h-auto lg:w-28"></div>
        <div className="absolute left-0 top-56 z-10 h-28 w-full bg-slate-800 lg:bottom-0 lg:left-56 lg:top-0 lg:h-auto lg:w-28"></div>
        <div className="absolute left-0 top-[21rem] z-10 h-24 w-full bg-slate-700 lg:bottom-0 lg:left-[21rem] lg:top-0 lg:h-auto lg:w-28"></div>

        <figure className="left-16 top-10 mx-auto w-64 justify-center gap-x-8 py-6 lg:absolute lg:ml-5 lg:w-[300px] z-20">
          <Link href={"/experts/profile/" + slug} className="mb-5 block">
          ...
          <figcaption className="mx-auto w-60">
            <h4 className="text-2xl font-bold text-primary-one">
              {profileDetails.name}
            </h4>
            ...
            <div className="my-2 font-medium text-slate-300">
              <p>
                <span className="text-primary-one">Expertise: </span>
                {profileDetails.expertise
                  ? profileDetails.expertise
                  : "Yoga, Work-life"}
              </p>
              <p>
                <span className="text-primary-one">Speaks: </span>
          ...
          <div className="pt-6 md:w-[580px] 2xl:w-[720px]">
            {!checkout ? (
              <form onSubmit={handleProceed}>
                <h2 className="mb-4 text-center text-white text-3xl font-bold">
                  Book Your Session
                </h2>
                ...
                <div className="mb-8 grid justify-center text-center">
                  ...
                  <div className="mb-4 flex text-slate-300 justify-between gap-x-2 lg:mb-0 lg:gap-x-5">
                    {modes.map((value, i) => {
                      return (
                        <SessionMode
                          key={i}
                ...
                <div className="mb-8 text-center">
                  <button
                    ...
                    className="btn-one !rounded-lg  enabled:!bg-primary-one disabled:cursor-not-allowed disabled:bg-gray-500 !text-black"
                  >
                    Proceed
                  </button>
                </div>
