...
import { ArrowVector, JournallingSmallPage } from "@public";
import axios from "axios";
import useToken from "@utils/useToken";
import Image from "next/image";
import UserChart from "@components/Dashboard/User/UserChart";
import MoodCalendar from "@components/Dashboard/User/MoodCalendar";
...
function GoalItem({ label }) {
  return (
    <li className="flex items-center text-lg font-semibold">
      <Image src={ArrowVector} alt="Arrow Icon" className="mr-2 h-4 w-4" />
