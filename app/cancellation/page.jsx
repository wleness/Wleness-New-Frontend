  ...
  return (
    <>
      ...
      <section className="bg-black">
        <div className="container mx-auto py-8 text-justify font-medium">
          <h2 className="mb-4 text-3xl text-white font-bold">
            Therapy Sessions
          </h2>
          ...
          <table className="mb-6 mt-5 text-left">
            <thead>
              <tr className="text-white">
                <th
                  className="border-2 border-slate-500 px-4 py-2 font-quicksand"
                  rowSpan={2}
                >
                  Completed Sessions
                </th>
                ...
                return (
                  <tr key={i}>
                    {value.map((data, index) => {
                      return (
                        <td
                          className="border-2 border-slate-500 text-slate-300 px-4 py-3"
                          key={index}
                        >
                          {data}
                        </td>
